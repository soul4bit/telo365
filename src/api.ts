...
export type WorkoutExercise={exerciseId:string;name?:string;unit:'reps'|'seconds';equipment?:string[];sets:WorkoutSet[];restSeconds?:number;targetRpe?:number;notes?:string;substitutionGroup?:string}

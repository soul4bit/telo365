# Blender 5.2+ template for TELO365 shoulder_press (female)
...
OUTPUT = find_repo_root() / 'public/media/exercises/animations/female/shoulder_press.glb'

raise RuntimeError(
    'No authored motion has been created. Create real shoulder_press key poses, manually review technique, then use the pipeline helper to export.'
)

# Blender 5.2+ template for TELO365 dumbbell_row (female)
...
OUTPUT = find_repo_root() / 'public/media/exercises/animations/female/dumbbell_row.glb'

raise RuntimeError(
    'No authored motion has been created. Create real dumbbell_row key poses, manually review technique, then use the pipeline helper to export.'
)

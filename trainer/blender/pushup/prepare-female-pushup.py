# Blender 5.2+ template for TELO365 pushup (female)
...
OUTPUT = find_repo_root() / 'public/media/exercises/animations/female/pushup.glb'

raise RuntimeError(
    'No authored motion has been created. Create real pushup key poses, manually review technique, then use the pipeline helper to export.'
)
